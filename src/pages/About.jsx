  ...
  const values = [
    {
      ...
      description:
        "Built on integrity with complete transparency in our trading strategies and performance.",
    },
    {
      icon: TrendingUp,
      title: "Proven Results",
      description:
        "Consistent track record of delivering superior returns through disciplined market analysis.",
    },
    {
      icon: Users,
      title: "Client Success",
      description:
        "Your financial growth is our priority. We succeed when our clients achieve their goals.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Since 2009, we've been helping traders navigate the complexities
              of financial markets with expert guidance, proven strategies, and
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-xl prose-gray max-w-none">
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Founded in 2009, Trading Scalph emerged from a simple yet
                powerful vision: to democratize access to professional trading
                expertise and help individuals achieve financial independence
                through informed market participation.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                What started as a commitment to excellence in options trading
                has evolved into a comprehensive platform serving thousands of
                clients across India. Our approach combines rigorous market
                analysis, risk management, and personalized support to deliver
                consistent results in an ever-changing market landscape.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              To empower every trader with the knowledge, tools, and support
              needed to make informed investment decisions and achieve
              sustainable financial growth in the dynamic world of securities
              trading.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-amber-800 leading-relaxed">
              Trading and investments in securities market carry inherent risks.
              Past performance does not guarantee future results. Please ensure
              you understand the risks involved and consider your financial
