        ...
        <section className="text-gray-600 body-font  px-5 md:px-10">
          <div className="flex  py-16 md:py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-16 md:pr-10 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <p className="mb-8 md:text-xl font-medium leading-relaxed">
              ...
              >
                ...
                <div className="p-2 w-full">
                  <button
                    type="submit"
                    className="cursor-pointer hover:opacity-95 flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none rounded text-lg"
                  >
                    Send
                  </button>
                </div>
          ...
          <div className="container md:px-4 md:pt-14 pb-24 mx-auto">
            <div className="flex flex-col w-full mb-14 text-center md:text-left">
              ...
              <p className="lg:w-2/3 leading-relaxed text-base">
                We’re available 365 days a year! Monday – Friday from 8am-8pm
            ...
            <div className="flex  flex-wrap justify-center md:justify-between items-center mt-8 gap-16 md:gap-4 mx-2">
              <div className="flex flex-col md:flex-row items-center md:gap-10 md:items-start">
                ...
                <div className="mt-6 sm:mt-1 text-center md:text-left">
                  ...
                  <a
                    ...
                    className="cursor-pointer inline-flex mt-4 text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:opacity-95 rounded text-lg"
                  >
                    Start Chat
                  </a>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center md:gap-10 md:items-start">
                ...
                <div className="mt-6 sm:mt-1 text-center md:text-left">
                  ...
                  <a
                    href="mailto:help@happysolutionss.com"
                    className="cursor-pointer inline-flex mt-4 text-blue-500 hover:text-blue-700 font-semibold py-2 rounded text-lg"
                  >
