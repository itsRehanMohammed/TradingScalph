...
const Home = () => {
  ...
  const filteredPackages = packages.filter(
    (pkg) => pkg.category === "index-option-combo-premium"
  );
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                  ...
                  expert stock market advisory services. At Capital Grow, we
            ...
            <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 rounded-3xl p-12 text-center shadow-2xl">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
                  Join thousands of successful traders who trust Capital Grow
